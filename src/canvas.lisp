...
(defun canvas-dict-T1  (canv) (x+ (canvas-dict-top    canv) (- (/ (canvas-dict-width  canv) 4))))
(defun canvas-dict-T2  (canv)     (canvas-dict-top    canv))
(defun canvas-dict-T3  (canv) (x+ (canvas-dict-top    canv)    (/ (canvas-dict-width  canv) 4)))
(defun canvas-dict-B1  (canv) (x+ (canvas-dict-bottom canv) (- (/ (canvas-dict-width  canv) 4))))
(defun canvas-dict-B2  (canv)     (canvas-dict-bottom canv))
(defun canvas-dict-B3  (canv) (x+ (canvas-dict-bottom canv)    (/ (canvas-dict-width  canv) 4)))
(defun canvas-dict-L1  (canv) (y+ (canvas-dict-left   canv) (- (/ (canvas-dict-height canv) 4))))
(defun canvas-dict-L2  (canv)     (canvas-dict-left   canv))
(defun canvas-dict-L3  (canv) (y+ (canvas-dict-left   canv)    (/ (canvas-dict-height canv) 4)))
(defun canvas-dict-R1  (canv) (y+ (canvas-dict-right  canv) (- (/ (canvas-dict-height canv) 4))))
(defun canvas-dict-R2  (canv)     (canvas-dict-right  canv))
(defun canvas-dict-R3  (canv) (y+ (canvas-dict-right  canv)    (/ (canvas-dict-height canv) 4)))

(defun canvas-dict-T1.X (canv) (point-x (canvas-dict-T1 canv)))
(defun canvas-dict-T1.Y (canv) (point-y (canvas-dict-T1 canv)))
(defun canvas-dict-T2.X (canv) (point-x (canvas-dict-T2 canv)))
(defun canvas-dict-T2.Y (canv) (point-y (canvas-dict-T2 canv)))
(defun canvas-dict-T3.X (canv) (point-x (canvas-dict-T3 canv)))
(defun canvas-dict-T3.Y (canv) (point-y (canvas-dict-T3 canv)))
(defun canvas-dict-B1.X (canv) (point-x (canvas-dict-B1 canv)))
(defun canvas-dict-B1.Y (canv) (point-y (canvas-dict-B1 canv)))
(defun canvas-dict-B2.X (canv) (point-x (canvas-dict-B2 canv)))
(defun canvas-dict-B2.Y (canv) (point-y (canvas-dict-B2 canv)))
(defun canvas-dict-B3.X (canv) (point-x (canvas-dict-B3 canv)))
(defun canvas-dict-B3.Y (canv) (point-y (canvas-dict-B3 canv)))
(defun canvas-dict-L1.X (canv) (point-x (canvas-dict-L1 canv)))
(defun canvas-dict-L1.Y (canv) (point-y (canvas-dict-L1 canv)))
(defun canvas-dict-L2.X (canv) (point-x (canvas-dict-L2 canv)))
(defun canvas-dict-L2.Y (canv) (point-y (canvas-dict-L2 canv)))
(defun canvas-dict-L3.X (canv) (point-x (canvas-dict-L3 canv)))
(defun canvas-dict-L3.Y (canv) (point-y (canvas-dict-L3 canv)))
(defun canvas-dict-R1.X (canv) (point-x (canvas-dict-R1 canv)))
(defun canvas-dict-R1.Y (canv) (point-y (canvas-dict-R1 canv)))
(defun canvas-dict-R2.X (canv) (point-x (canvas-dict-R2 canv)))
(defun canvas-dict-R2.Y (canv) (point-y (canvas-dict-R2 canv)))
(defun canvas-dict-R3.X (canv) (point-x (canvas-dict-R3 canv)))
(defun canvas-dict-R3.Y (canv) (point-y (canvas-dict-R3 canv)))
...
;;環境を確立し、コード `body` を実行します。使用例は [$@ 節](#サブキャンバス)を参照して
;;ください。
;;
;;${SEE_ALSO}
;;
