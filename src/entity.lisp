...
(defun attribute-T1  (shp) (x+ (attribute-top    shp) (- (/ (attribute-width  shp) 4))))
(defun attribute-T2  (shp)     (attribute-top    shp))
(defun attribute-T3  (shp) (x+ (attribute-top    shp)    (/ (attribute-width  shp) 4)))
(defun attribute-B1  (shp) (x+ (attribute-bottom shp) (- (/ (attribute-width  shp) 4))))
(defun attribute-B2  (shp)     (attribute-bottom shp))
(defun attribute-B3  (shp) (x+ (attribute-bottom shp)    (/ (attribute-width  shp) 4)))
(defun attribute-L1  (shp) (y+ (attribute-left   shp) (- (/ (attribute-height shp) 4))))
(defun attribute-L2  (shp)     (attribute-left   shp))
(defun attribute-L3  (shp) (y+ (attribute-left   shp)    (/ (attribute-height shp) 4)))
(defun attribute-R1  (shp) (y+ (attribute-right  shp) (- (/ (attribute-height shp) 4))))
(defun attribute-R2  (shp)     (attribute-right  shp))
(defun attribute-R3  (shp) (y+ (attribute-right  shp)    (/ (attribute-height shp) 4)))

(defun attribute-T1.X (shp) (point-x (attribute-T1 shp)))
(defun attribute-T1.Y (shp) (point-y (attribute-T1 shp)))
(defun attribute-T2.X (shp) (point-x (attribute-T2 shp)))
(defun attribute-T2.Y (shp) (point-y (attribute-T2 shp)))
(defun attribute-T3.X (shp) (point-x (attribute-T3 shp)))
(defun attribute-T3.Y (shp) (point-y (attribute-T3 shp)))
(defun attribute-B1.X (shp) (point-x (attribute-B1 shp)))
(defun attribute-B1.Y (shp) (point-y (attribute-B1 shp)))
(defun attribute-B2.X (shp) (point-x (attribute-B2 shp)))
(defun attribute-B2.Y (shp) (point-y (attribute-B2 shp)))
(defun attribute-B3.X (shp) (point-x (attribute-B3 shp)))
(defun attribute-B3.Y (shp) (point-y (attribute-B3 shp)))
(defun attribute-L1.X (shp) (point-x (attribute-L1 shp)))
(defun attribute-L1.Y (shp) (point-y (attribute-L1 shp)))
(defun attribute-L2.X (shp) (point-x (attribute-L2 shp)))
(defun attribute-L2.Y (shp) (point-y (attribute-L2 shp)))
(defun attribute-L3.X (shp) (point-x (attribute-L3 shp)))
(defun attribute-L3.Y (shp) (point-y (attribute-L3 shp)))
(defun attribute-R1.X (shp) (point-x (attribute-R1 shp)))
(defun attribute-R1.Y (shp) (point-y (attribute-R1 shp)))
(defun attribute-R2.X (shp) (point-x (attribute-R2 shp)))
(defun attribute-R2.Y (shp) (point-y (attribute-R2 shp)))
(defun attribute-R3.X (shp) (point-x (attribute-R3 shp)))
(defun attribute-R3.Y (shp) (point-y (attribute-R3 shp)))
