...
(defmethod check ((ent arc) canvas dict)
  ...
  (with-slots (center pt1 pt2 rx ry x-axis-rotation degree1 degree2 end1 end2) ent
...
(defmethod draw-entity ((ent arc) writer)
  (call-next-method)
  ;; endmark 処理 : internal doc の「円弧の端点における傾きの計算方法」参照e
...
(defmacro arc (center rx ry x-axis-rotation
					  degree1 degree2 &key stroke end1 end2 layer filter id)
