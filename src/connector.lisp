...
(defun resolve-connector-points-for-BB (pos1 pos2 e1 e2)
  (let ((dist *default-connector-spacing*))
	(with-point (x1 y1) (shape-connect-point e1 :from :bottom pos1)
	  (with-point (x2 y2) (shape-connect-point e2 :dest :bottom pos2)
		(labels ((points4 ()
...
(defun resolve-connector-points-for-TT (pos1 pos2 e1 e2)
  (let ((dist *default-connector-spacing*))
	(with-point (x1 y1) (shape-connect-point e1 :from :top pos1)
	  (with-point (x2 y2) (shape-connect-point e2 :dest :top pos2)
		(labels ((points4 ()
...
(defun resolve-connector-points-for-LL (pos1 pos2 e1 e2)
  (let ((dist *default-connector-spacing*))
	(with-point (x1 y1) (shape-connect-point e1 :from :left pos1)
	  (with-point (x2 y2) (shape-connect-point e2 :dest :left pos2)
		(labels ((points4 ()
...
(defun resolve-connector-points-for-RR (pos1 pos2 e1 e2)
  (let ((dist *default-connector-spacing*))
	(with-point (x1 y1) (shape-connect-point e1 :from :right pos1)
	  (with-point (x2 y2) (shape-connect-point e2 :dest :right pos2)
		(labels ((points4 ()
